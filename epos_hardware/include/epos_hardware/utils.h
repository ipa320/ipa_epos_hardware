...
{
public:
  NodeHandle(DeviceHandlePtr device_handle, unsigned short node_id) : device_handle(device_handle), node_id(node_id)
  {
  }
...
public:
  ...
  int EnumerateNodes(const std::string device_name,
                     const std::string protocol_stack_name,
                     const std::string interface_name,
                     const std::string port_name,
